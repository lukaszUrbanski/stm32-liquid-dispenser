...
//
////
//// Basic functions - write to your MCU
////
...
//}
//
//static void ILI9341_SedToTFT(uint8_t *Byte, uint32_t Length)
//{
//	HAL_SPI_Transmit(Tft_hspi, Byte, Length, ILI9341_TIMEOUT);
//}
//
//static void ILI9341_SendCommand(uint8_t Command)
//{
...
//	ILI9341_DC_HIGH;
//
//	// Send to TFT Length-bytes
//	ILI9341_SedToTFT(Data, Length);
//
//	//CS HIGH
//#if(ILI9341_USE_CS == 1)
//	ILI9341_CS_HIGH;
...
//	DataToTransfer[3] = x2 && 0xFF;
//
//	ILI9341_SendCommandAndData(ILI9341_CASET, DataToTransfer, 4); // Column address set
//
//	DataToTransfer[0] = y1 >> 8;
//	DataToTransfer[1] = y1 && 0xFF;
//	DataToTransfer[2] = y2 >> 8;
//	DataToTransfer[3] = y2 && 0xFF;
//
//	ILI9341_SendCommandAndData(ILI9341_PASET, DataToTransfer, 4); // Row address set
//}
//
//
...
//{
//	ILI9341_SetAddrWindow(0, 0, ILI9341_TFTHEIGHT, ILI9341_TFTWIDTH);
//	ILI9341_SendData16(color);
//}
//
//static const uint8_t initcmd[] = {
